...
names(df.species)[1] <- " "
v.align <- c(rep("l",2), rep("r",3))
knitr::kable(df.species, caption="(ref:cap-species)", booktabs=TRUE, align=v.align, linesep="") %>%
...
v.align <- c("l",rep("r",4))
knitr::kable(df.gdms, caption="(ref:cap-gdms)", booktabs=TRUE, align=v.align, linesep="") %>%
  kable_styling(latex_options=c("HOLD_position", "striped"), full_width=FALSE, position="center") %>%
...
# Kable
knitr::kable(df.livrables, caption="(ref:cap-livrables)", align="lll", booktabs=TRUE, linesep="") %>%
  kable_styling(latex_options=c("HOLD_position","striped"), full_width=FALSE, position="center") %>%
