...
(ref:cap-livrables) **Livrables du projet BioSceneMada.** Les livrables sont classés par catégories ("Bases de données", "Cartes", etc.). Les articles, disposant d'une section spécifiques dans le rapport, n'ont pas été repris.
...
# Kable
knitr::kable(df.livrables, caption="(ref:cap-livrables)", booktabs=TRUE, format="latex") %>%
