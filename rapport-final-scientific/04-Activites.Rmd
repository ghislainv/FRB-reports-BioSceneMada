...
names(df.species)[1] <- " "
knitr::kable(df.species, caption="(ref:cap-species)", booktabs=TRUE, align="llrrr", linesep="") %>%
...
```{r GDM, ou.width="80%", fig.cap="(ref:cap-GDM)"}
...
knitr::kable(df.gdms, caption="(ref:cap-gdms)", booktabs=TRUE, align="lrrrr", linesep="") %>%
  kable_styling(latex_options=c("hold_position","striped"))
```
...
# Kable
knitr::kable(df.livrables, caption="(ref:cap-livrables)", booktabs=TRUE, linesep="") %>%
  kable_styling(latex_options=c("hold_position","striped")) %>%
